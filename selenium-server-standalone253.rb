class SeleniumServerStandalone253 < Formula
  ...
  def install
    libexec.install "selenium-server-standalone-2.53.1.jar"
    bin.write_jar_script libexec/"selenium-server-standalone-2.53.1.jar", "selenium-server"
  end
  ...
  def plist; <<-EOS.undent
    ...
    <dict>
      ...
      <array>
        ...
        <string>-jar</string>
        <string>#{libexec}/selenium-server-standalone-2.53.1.jar</string>
        <string>-port</string>
        <string>4444</string>
      </array>
